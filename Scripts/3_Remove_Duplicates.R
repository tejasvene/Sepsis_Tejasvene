...
expr = tmp.expr
expr[is.na(expr)] = 0
df4_4421_51 = expr  %>% as.data.frame()
df4_4421_51 <- cbind(Gene_ID = rownames(df4_4421_51), df4_4421_51)
...
expr1 = tmp.expr1
expr1[is.na(expr1)] = 0
df4_33314 = expr1  %>% as.data.frame()
df4_33314 <- cbind(Gene_ID = rownames(df4_33314), df4_33314)
...
expr2 = tmp.expr2
expr2[is.na(expr2)] = 0
df4_27131 = expr2  %>% as.data.frame()
df4_27131 <- cbind(Gene_ID = rownames(df4_27131), df4_27131)
...
expr3 = tmp.expr3
expr3[is.na(expr3)] = 0
df4_54514 = expr3  %>% as.data.frame()
df4_54514 <- cbind(Gene_ID = rownames(df4_54514), df4_54514)
...
expr4 = tmp.expr4
expr4[is.na(expr4)] = 0
df4_95233 = expr4  %>% as.data.frame()
df4_95233 <- cbind(Gene_ID = rownames(df4_95233), df4_95233)
...
expr5 = tmp.expr5
expr5[is.na(expr5)] = 0
df4_65682 = expr5  %>% as.data.frame()
df4_65682 <- cbind(Gene_ID = rownames(df4_65682), df4_65682)
